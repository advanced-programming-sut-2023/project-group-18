...
public enum Asset {
    ...
    TORCH("Torch", AssetType.WEAPON,0),
    SLING("Sling", AssetType.WEAPON, 0),
    SCIMITAR("Scimitar", AssetType.WEAPON, 0),
    ARABIAN_BOW("Bow", AssetType.WEAPON, 0),
    GREEK_FIRE("Greek Fire", AssetType.WEAPON, 0),
    ARABIAN_METAL_ARMOR("Metal Armour", AssetType.WEAPON, 0),
    STAFF("Staff", AssetType.WEAPON, 0),
    PICK_AXE("Pick Axe", AssetType.WEAPON,0),
